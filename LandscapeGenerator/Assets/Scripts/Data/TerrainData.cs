...
public class TerrainData : UpdatableData
{
    ...
    public float MinHeight => 0f; // 1 es el valor base de la amplitud

    public float MaxHeight => parameters.scale * parameters.heightScale; // 8 son las octavas máximas y la persistencia máxima es 1,
